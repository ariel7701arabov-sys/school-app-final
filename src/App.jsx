                  ...
                  <div className="lg:col-span-2">
                    {selectedExamId ? (
                      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                        ...
                        <table className="w-full"><thead className="bg-slate-50 border-b text-sm"><tr><th className="px-6 py-3 text-right">תלמיד</th><th className="px-6 py-3 text-center w-32">ציון</th></tr></thead><tbody className="divide-y divide-slate-100">
        ...
        {userRole === 'admin' && activeTab === 'dismissal' && (
          <div className="space-y-6">
             <div className="bg-indigo-900 text-white p-6 rounded-2xl shadow-lg flex flex-col md:flex-row justify-between items-center gap-4">
                <div><h2 className="text-2xl font-bold flex items-center gap-2"><Timer />דו"ח יציאה</h2>
                ...
                <div className="flex flex-col gap-2 items-end">
                   ...
                   <div className="flex gap-2 items-center">
                      <div className="flex flex-col">
                        <input type="date" value={reportRange.start} onChange={(e) => setReportRange({...reportRange, start: e.target.value})} className="bg-indigo-800 border-none rounded-lg text-xs p-2 text-white" />
                        <span className="text-[10px] text-indigo-200 text-center font-bold">{formatHebrewDate(reportRange.start)}</span>
                      </div>
                      <span className="text-indigo-300 self-center">עד</span>
                      <div className="flex flex-col">
                        <input type="date" value={reportRange.end} onChange={(e) => setReportRange({...reportRange, end: e.target.value})} className="bg-indigo-800 border-none rounded-lg text-xs p-2 text-white" />
                        <span className="text-[10px] text-indigo-200 text-center font-bold">{formatHebrewDate(reportRange.end)}</span>
                      </div>
                   </div>
                </div>
             </div>
